...
<head>
    <title>Datenschutzerklärung | Treo Cloud</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>Wir haben einen Datenschutzbeauftragten für unser Unternehmen ernannt:</p>
                ...
                <p>So werden sämtliche Daten gespeichert, welche im Rahmen einer Bestellabwicklung von den Kunden eingegeben werden, unter anderem Name, Vorname, Firmenname, Adresse, Daten zu Zahlungsabwicklung, UST-ID und die E-Mail-Adresse.</p>
